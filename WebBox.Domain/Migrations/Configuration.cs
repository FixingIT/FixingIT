...
{
    internal sealed class Configuration : DbMigrationsConfiguration<WebBox.Domain.Contexts.WebBoxDb>
    {
        ...
        protected override void Seed(WebBox.Domain.Contexts.WebBoxDb context)
        {
            try
            {
                #region UserThemes
                ...
                #region Membership
                WebSecurity.InitializeDatabaseConnection("WebBoxDb", "WebBox.UserProfile", "ID", "Email", autoCreateTables: true);
